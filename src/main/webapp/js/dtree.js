...
dTree.prototype.node = function(node, nodeId) {
	var str = '<div class="dTreeNode" style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;	font-size: 11px;	color: #333;">' + this.indent(node, nodeId);
	...
	if (node.url) {
		str += '<a style="font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;	font-size: 11px;	color: #333;" id="s' + this.obj + nodeId + '" class="' + ((this.config.useSelection) ? ((node._is ? 'nodeSel' : 'node')) : 'node') + '" href="' + node.url + '"';
		...
		str += '<a style="color:#333;font-family: Verdana, Geneva, Arial, Helvetica, sans-serif;	font-size: 11px;"  href="javascript: ' + this.obj + '.o(' + nodeId + ');" class="node">';
	//===============================================
